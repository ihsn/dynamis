...
project = 'DYNAMIS-POP'
copyright = '2018, Martin Spielauer'
...
source_parsers = {
   ...
   '.Rmd': 'recommonmark.parser.CommonMarkParser',
}
...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', 'Web']
...
latex_documents = [
    (master_doc, 'sphname.tex', 'sphname Documentation',
     'ms', 'manual'),
]
...
man_pages = [
    (master_doc, 'sphname', 'sphname Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'sphname', 'sphname Documentation',
     author, 'sphname', 'One line description of project.',
     'Miscellaneous'),
]
